...
<html lang="">
    ...
    <body>
        ...
        <form action="{{route('auth.registration')}}" method="post">
            @csrf
            <div class="container">
                <label for="name" class="@error('name') is-invalid @enderror"><b>Username</b></label>
                <input type="text" placeholder="Enter name" id="name" name="name" class="@error('name') is-invalid @enderror" {{old('name')}} required>
                ...
                <input type="password" placeholder="Enter Password" id="password" class="@error('password') is-invalid-input @enderror" name="password" required>
                @if ($errors->any())
